...
import com.tutorix.tutorialspoint.adapters.NotesAdapter;
...
public class AllNotesActivity extends AppCompatActivity {
    ...
    NotesAdapter subchaptersAdapter;
    ...
    private void initData()
    {
        ...
        lnr_home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent in=new Intent(AllNotesActivity.this, HomeTabActivity.class);
...
*/
    ...
    private void LoadData() {
        ...
        data = (ArrayList<SubChapters>) dbhelper.subjectChapterDAO().getBookMarkDetailsNotes( userId,classId);
    ...
    private void fillWithData() throws UnsupportedEncodingException {
        ...
        try {
            ...
            fjson.put(Constants.action_type, "N");
    ...
    private void addAdapter(ArrayList<SubChapters> dataList)
    {
        ...
        subchaptersAdapter = new NotesAdapter(AllNotesActivity.this);
        recyclerView.setAdapter(subchaptersAdapter);
        if(dataList!=null)
        subchaptersAdapter.addData(dataList);
    ...
    private void nodata()
    {
        if(subchaptersAdapter!=null&&subchaptersAdapter.getItemCount()>0)
        {
            lnr_reload.setVisibility(View.GONE);
        }else{
            lnr_reload.setVisibility(View.VISIBLE);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(resultCode==200)
        {
            ...
            subchaptersAdapter.updatedNotes(text);
        }

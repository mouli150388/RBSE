...
public class CropImageActivity extends AppCompatActivity
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    lnr_flip = findViewById(R.id.lnr_flip);
    ...
    txt_vertical.setOnClickListener(new View.OnClickListener() {
      @Override
      public void onClick(View v) {
        lnr_flip.setVisibility(View.GONE);
        mCropImageView.flipImageVertically();
      }
    });txt_horizontal.setOnClickListener(new View.OnClickListener() {
      @Override
      public void onClick(View v) {
        lnr_flip.setVisibility(View.GONE);
   ...
   /* ActionBar actionBar = getSupportActionBar();
    ...
    bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
      ...
      public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (item.getItemId() == R.id.crop_menu_flip) {
          if(lnr_flip.getVisibility()==lnr_flip.VISIBLE)
          {
            lnr_flip.setVisibility(View.GONE);
            return true;
          }
        ...
        lnr_flip.setVisibility(View.GONE);
          if (item.getItemId() == R.id.crop_image_menu_back) {
            mCropImageView.setImageUriAsync(mCropImageUri);
            return true;
          }if (item.getItemId() == R.id.crop_image_menu_next) {
          //continueWithoutCrop();
          cropImage();
            return true;
...
/*  @Override
  ...
  Uri finalUri;
    Exception error;
    int sampleSize;
  CropImageFragemtn lecturDescFragment;
  ...
  public void setResultFromCrop()
  {

    int resultCode = error == null ? RESULT_OK : CropImage.CROP_IMAGE_ACTIVITY_RESULT_ERROR_CODE;
    setResult(resultCode, getResultIntent(finalUri, error, sampleSize));
   try {
     if (lecturDescFragment != null) {
       lecturDescFragment.dismiss();
     }
   }catch (Exception e)
   {
     e.printStackTrace();
  ...
  public void continueWithoutCrop()
  {
    //mCropImageView.getCroppedImageAsync();
    int resultCode = error == null ? RESULT_OK : CropImage.CROP_IMAGE_ACTIVITY_RESULT_ERROR_CODE;
    setResult(resultCode, getResultIntent(mCropImageView.getImageUri(), error, sampleSize));
    finish();
  }
  ...
  // endregion
    ...
    {
      lnr_flip.setVisibility(View.VISIBLE);

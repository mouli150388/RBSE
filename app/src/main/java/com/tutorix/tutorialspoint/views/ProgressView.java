...
import static com.tutorix.tutorialspoint.views.ProgressView.Direction.FROM_RIGHT;
...
public class ProgressView extends View {
    ...
    private @ColorInt
    int mBackgroundColor, mProgressColor;
    ...
    private void drawArc(Canvas canvas, float sweepAngle) {
        ...
        if(rate!=null)
        canvas.drawText(rate,getWidth()/4,getHeight()-10,mtextPaint);

package com.tutorix.tutorialspoint.views.smilerating;
...
public class SmileRating extends BaseRating {
    ...
    private int mAngryColor = Color.parseColor("#FF0000");
    //private int mNormalColor = Color.parseColor("#f2dd68");
    private int mNormalColor = Color.parseColor("#efcc07");
    private int mDrawingColor = Color.parseColor("#000000");
    ...
    //private int mPlaceholderBackgroundColor = Color.parseColor("#39339B");
...
//    private Path mEyePathRight = new Path();
    ...
    @Smiley
    private int mPreviousSmile = BaseRating.NONE;
    @Smiley

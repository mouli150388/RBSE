    ...
    public static boolean isEmulator(Context ctx) {
        ...
        if(rating < 0) {
            ...
            if (Build.HARDWARE.equals("goldfish") ||
                    ...
                    Build.HARDWARE.contains("marlin") ||
            ...
            if (Build.FINGERPRINT.contains("generic/sdk/generic") ||
                    ...
                    Build.FINGERPRINT.contains("marlin") ||
       ...
       // CommonUtils.showToast(ctx,"Count "+rating);

        //Toast.makeText(ctx,"Count "+rating,Toast.LENGTH_LONG).show();
        //Log.v("IsEmulator","IsEmulator rating "+rating);
        return rating > 2;
    }
